...
import { getDashboardMetrics, getActiveProjects, getActiveSpecialists, getRecentActivity } from "../actions";
import { OverviewCalendarWidget } from "./calendar-widget";
          ...
          <Card>
            <CardHeader className="pb-2 flex flex-row items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild className="h-7 text-xs">
                <Link href="/admin/equipment-usage">Ver todo</Link>
              </Button>
            </CardHeader>
            <CardContent>
            ...
            <CardContent className="grid grid-cols-2 gap-2">
              <Button variant="outline" size="sm" asChild className="h-auto py-3 flex-col gap-1">
                <Link href="/admin/blog/nuevo">
                  <FileText className="h-4 w-4 text-blue-500" />
                  <span className="text-[10px]">Nuevo Post</span>
                </Link>
              </Button>
              <Button variant="outline" size="sm" asChild className="h-auto py-3 flex-col gap-1">
