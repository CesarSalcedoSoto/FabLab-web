...
import { getCalendarEvents, type CalendarEvent } from "../calendario/actions";
...
export function OverviewCalendarWidget() {
  const now = new Date();
    ...
    <Card className="h-full">
      <CardHeader className="pb-3 flex flex-row items-center justify-between">
        ...
        <Button variant="ghost" size="sm" asChild className="text-xs">
          <Link href="/admin/calendario">Ver completo</Link>
        </Button>
      </CardHeader>
      <CardContent>
        {/* Month Navigation */}
        ...
        {selectedDate && (
          <div className="border-t pt-3 mt-1">
            ...
            {selectedEvents.length === 0 ? (
              <p className="text-xs text-gray-400 text-center py-3">Sin eventos este dia</p>
            ) : (
