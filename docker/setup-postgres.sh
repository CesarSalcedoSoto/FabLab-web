...
echo ""
echo "DATABASE_URL=postgresql://$DB_USER:$DB_PASSWORD@$DOCKER_GATEWAY:9012/$DB_NAME"
echo ""
echo "============================================"
echo ""
echo "Próximos pasos:"
echo "1. Crea/edita el archivo .env en /opt/FabLab-web/docker/.env con esta DATABASE_URL"
echo "2. Ejecuta: chmod 600 /opt/FabLab-web/docker/.env"
echo "3. Despliega: cd /opt/FabLab-web/docker && docker compose up -d --build web"
echo ""
